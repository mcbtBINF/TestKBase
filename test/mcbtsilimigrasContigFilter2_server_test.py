...
from mcbtsilimigrasContigFilter2.mcbtsilimigrasContigFilter2Impl import mcbtsilimigrasContigFilter2
from mcbtsilimigrasContigFilter2.mcbtsilimigrasContigFilter2Server import MethodContext
from mcbtsilimigrasContigFilter2.authclient import KBaseAuth as _KBaseAuth

from AssemblyUtil.AssemblyUtilClient import AssemblyUtil

class mcbtsilimigrasContigFilter2Test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('mcbtsilimigrasContigFilter2'):
        ...
        cls.ctx.update({'token': token,
                        'user_id': user_id,
                        'provenance': [
                            {'service': 'mcbtsilimigrasContigFilter2',
        ...
        cls.serviceImpl = mcbtsilimigrasContigFilter2(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_mcbtsilimigrasContigFilter2_" + str(suffix)
